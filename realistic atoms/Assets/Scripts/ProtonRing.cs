...
public class ProtonRing : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ring = new GameObject(name + " Ring"); //sets ring variable to a new game object. name in this case for the minute is just nucleus. so therefore "nucleus ring". this allows us to know which ring is associated with what object in the hierarchy
